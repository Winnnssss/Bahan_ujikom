...
<div class="container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2">Form Edit Barang </h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-10 pd-sm-20 bg-gray-100">
                        <form action="{{ route('data_barang.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <input class="form-control" placeholder="" type="text" name="nama" value="{{isset($data->nama)?$data->nama:old('nama')}}">
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <select class="form-control select2" name="kategori_id">
                                                ...
                                                <option value="{{$val->id}}" @if($data->kategori_id==$val->id) selected @endif>{{$val->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <input class="form-control numberonly" name='harga_satuan' placeholder="" type="text" onkeyup="this.value=number_format(this.value)" value="{{isset($data->harga_satuan)?$Konversi->uang($data->harga_satuan??''):old('harga_satuan')}}">
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <input class="form-control numberonly" name='harga_jual' placeholder="" type="text" onkeyup="this.value=number_format(this.value)" value="{{isset($data->harga_jual)?$Konversi->uang($data->harga_jual??''):old('harga_jual')}}">
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <input class="form-control" placeholder="" type="text" name="satuan" value="{{isset($data->satuan)?$data->satuan:old('satuan')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">   
                        ...
                        <a href="{{route('data_barang')}}" class="btn btn-secondary pd-x-30 mg-t-5"><i class='fa fa-chevron-left'></i> Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
